...
export default function Demo() {
    ...
    const [quotedToTokenAmount, setQuotedToTokenAmount] =
        useState<string>("0.0");
    ...
    async function approve() {
        ...
        const response = await fromTokenContract.approve(
            spenderAddress,
            MaxInt256
        );
        ...
        <Column>
            <Row>
                ...
                <Column>
                    ...
                    <div>
                        Chain:{" "}
                        {chainId
                            ? CHAIN_INFO_LIST[chainId as SupportedChainId]
                                  .network
                            : "Not connected"}
                    </div>
                </Column>
            ...
            <Row>
                ...
                <select
                    value={toToken}
                    onChange={(event) =>
                        setToToken(event.target.value as SupportedToken)
                    }
                >
                    {supportedTokenOptions}
                </select>
