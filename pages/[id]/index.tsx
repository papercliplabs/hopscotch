...
export default function RequestPage() {
    ...
    const formattedOutputAmount = formatTokenAmount(requestData?.recipientTokenAmount, outputToken?.decimals, 6);
                ...
                >
                    ...
                    <Flex direction="column" ml={3}>
                        <Text textStyle="titleSm">
                            <Text as="span" variant="gradient">
                                <Link href={recipientAddressExplorerLink} isExternal>
                                    <Tooltip
                                        label={requestData?.recipientAddress}
                                        p={3}
                        ...
                        <Text variant="secondary" textStyle="bodySm">
                            Choose the token you want to pay with and it will be converted to {outputToken.symbol}{" "}
                            before sending.
                        </Text>
                    </Flex>
                </Flex>
